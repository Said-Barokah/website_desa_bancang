...
<div id="default-carousel" class="relative" data-carousel="static">
    <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:min-h-screen 2xl:min-h-screen">
        <div class="duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-0 z-20" data-carousel-item="">
            <img src="storage/images/corousel/slide-bg-1.webp" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
            <div class="w-full h-full flex justify-start items-center">
                <div class="z-50 ml-12 flex flex-col">
                    <h1 class="font-bold text-6xl text-zinc-500 w-1/2 h-min mb-9">Selamat Datang di Website Desa Bancang</h1>
                    <h5 class="text-xl text-zinc-600 w-1/2 h-min mb-9">Website desa Bancang dibangun bertujuan sebagai sarana untuk menyampaikan informasi terbaru dan menarik mengenai desa bancang. Website ini dibangun oleh kelompok KKNT 112 Universitas Trunojoyo Madura tahun 2022</h5>
                    <Link href="" class="link-button-1 rounded-full bg-zinc-700 text-white w-max">Baca Selengkapnya</Link>
                </div>
            </div>
        </div>
    ...
    <div class="custom-shape-divider-bottom-1654902622 z-40">
