...
export default {
    ...
    methods: {
        submit(id) {
            this.$inertia.patch(route('villagers.update',id), this.form)
        },
    },
}
</script>
