    ...
    data() {
        return {
            form: {
                ...
                places_of_birth: this.villager.places_of_birth,
                birthday: this.villager.birthday,
                blood_type_id: this.villager.blood_type_id,
                gender_id: this.villager.gender_id,
                religion_id: this.villager.religion_id,
                marital_status_id: this.villager.marital_status_id,
                profession_id: this.villager.profession_id,
                nationality_id: this.villager.nationality_id
