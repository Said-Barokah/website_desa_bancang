...
<AdminLayout :user="user">
    <div class="w-full">
        ...
        <div>
            ...
            <alert-danger v-show="$page.props.errors.manager_id" :message="'Data gagl disimpan ' + $page.props.errors.manager_id"></alert-danger>
        ...
        <div class="overflow-x-auto shadow-md sm:rounded-lg w-full mt-4">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr v-for="b_p_d_structure in b_p_d_structures.data" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap" :title=" b_p_d_structure.villager.nik">
                            <Link :href="route('BPD-structure.edit',b_p_d_structure.id)">{{ b_p_d_structure.villager.name }}</Link>
                        </th>
                        <td class="px-6 py-4">
        ...
        <div class="mt-4">
            <div class="flex justify-end">
                <Link v-show="b_p_d_structures.prev_page_url" :href='keyword == null ? b_p_d_structures.prev_page_url : b_p_d_structures.prev_page_url+"&keyword="+keyword' class="inline-flex items-center py-2 px-4 mr-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                ...
                <Link v-show="!isHiddenNextPagination" :href="keyword == null ? b_p_d_structures.next_page_url : b_p_d_structures.next_page_url+'&keyword='+keyword  " class="inline-flex items-center py-2 px-4 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                Next
...
export default {
    ...
    methods: {
        ...
        submit() {
            this.$inertia.get(route('BPD-structure.index'), this.form)
        },
    },
    created() {
        if (this.b_p_d_structures.next_page_url != null) {
